...
#R work directory
setwd("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup") # May have to adapt that
...
est.r[i] <- 0.48*bM[group[i]]*estM[i]+0.52*bTmax[group[i]]/estTmax[i]
...
# Bundle data
win.data <- list("r","M","Tmax","n","group")
...
inits <- function()
  list (
    ...
    bM=c(1,1,1), bTmax=c(1,0,1),  
    tau.M=0.01, tau.Tmax=1,tau.r=1,
    estM=dat$M, estTmax=dat$Tmax,
    r.new=dat$r)
...
params <- c("bM", "bTmax",
            ...
            "tau.r","sigma_r","sigma_M","sigma_Tmax",
            "bpvalue","predicted", 
            "estM","estTmax","est.r","residual")
...
# require(devEMF)
# emf("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\residual plot mix without beta0.emf",
#     width = 6.7, height = 3.35)
pdf('E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\figure\\figure 6.pdf',width=7, height=3.8,onefile = FALSE)
par(mfrow=c(1,2))
...
library(xlsx)
write.xlsx(stat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\ensemble mix without beta0.xlsx",sheetName = "stat",row.names=T)
write.xlsx(coe,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\ensemble mix without beta0.xlsx",sheetName = "coe",row.names=T,append=T)
write.xlsx(result,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\ensemble mix without beta0.xlsx",sheetName = "result",row.names=T,append=T)
write.xlsx(loo_mat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\ensemble mix without beta0.xlsx",sheetName = "loo_estimates",row.names=T,append=T)


#！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
# # require(devEMF)
# emf("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\mix without beta0.emf",
#     width = 3.35, height = 3.35)
# observed=r
# BHEIV_predicted=out$mean$predicted#BHEIV model predicted r
# plot(observed,col="red",pch=1, main = "rMTmaxgroup mix without beta0",cex.main=0.8,
#      xlab = "index",ylab="r")
...
write.xlsx(r_com,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\ensemble mix without beta0.xlsx",sheetName = "r_com",row.names=T,append=T)
...
p_com=data.frame(M,est_M,sigma_M,
                 Tmax,est_Tmax)
write.xlsx(p_com,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMTmaxgroup\\ensemble mix without beta0.xlsx",sheetName = "p_com",row.names=T,append=T)
...
#   # theme(legend.position=c(.98, .99),legend.justification = c("right", "top"))+
...
# library(magrittr)
# library(ggpubr)
# pdf('E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\figure\\figure 7.pdf',width=8, height=4,onefile = FALSE)
...
#           font.label=list(size=10,face="plain"),ncol = 2, nrow =1,common.legend = TRUE, legend = "top",vjust=0.5)
# 
# dev.off()
