...
#R work directory
setwd("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMGroup") # May have to adapt that
...
# mu.bk ~ dnorm(0, 0.000001)
# tau.bk~ dgamma (0.5, 0.1)
...
params <- c("bM","bpvalue", "mu.bM","tau.bM","tau.M","tau.r","sigma_r","sigma_M","predicted",
            "estM","residual")
...
# require(devEMF)
# emf("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\residual plot lm without beta01.emf",
#     width = 6.7, height = 3.35)
pdf('E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\figure\\figure 4.pdf',width=7, height=3.8,onefile = FALSE)
par(mfrow=c(1,2))
...
library(xlsx)
write.xlsx(stat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.xlsx",sheetName = "stat",row.names=T)
write.xlsx(coe,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.xlsx",sheetName = "coe",row.names=T,append=T)
write.xlsx(result,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.xlsx",sheetName = "mp metrics",row.names=T,append=T)
write.xlsx(waic_mat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.xlsx",sheetName = "waic_mat",row.names=T,append=T)




# # ！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
# emf("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.emf",width = 3.35, height = 3.35)
# observed=r
# BHEIV_predicted=out$mean$predicted#BHEIV model predicted r
# plot(observed,col="red",pch=1, main = "rMgroup lm without beta01",cex.main=0.8,
#      xlab = "index",ylab="r")
...
write.xlsx(r_com,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.xlsx",sheetName = "r_com",row.names=T,append=T)



est_M=out$mean$estM
M_com=data.frame(M,est_M)
write.xlsx(M_com,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMgroup\\lm without beta01.xlsx",sheetName = "M_com",row.names=T,append=T)
...
pdf('E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\figure\\figure 5.pdf',width=4.1, height=3.5,onefile = FALSE)
