...
#predicted new data
for (j in 1:m) 	{
LgM.test[j]<- log(M.test[j])
estM.test[j] ~ dlnorm(LgM.test[j], tau.M)
rnew.test[j]~ dnorm(est.rnew.test[j], tau.r)
est.rnew.test[j]<-bM[group.test[j]]/estM.test[j]
}
...
# Bundle data
win.data <- list("r","M","group","n","M.test","m","group.test")
...
# params <- c("bM","mu.bM","tau.bM","tau.M","tau.r","bpvalue","predicted",
#             "estM","residual")
params <- c("bM","rnew.test","estM.test","bpvalue","mu.bM","tau.bM","tau.M","tau.r",
            "estM","residual")
...
# 
write.xlsx(stat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\data\\162data\\M1 new 10 stocks.xlsx",sheetName="stat",append=T)
write.xlsx(coe,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\data\\162data\\M1 new 10 stocks.xlsx",sheetName="coe",append=T)
write.xlsx(BHEIV_errors,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\data\\162data\\M1 new 10 stocks.xlsx",sheetName="BHEIV_errors",append=T)
write.xlsx(FL_errors,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\data\\162data\\M1 new 10 stocks.xlsx",sheetName="FL_errors",append=T)
