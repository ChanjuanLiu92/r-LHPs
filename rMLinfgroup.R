...
#R work directory
setwd("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup") # May have to adapt that
...
est.r[i] <- bM[group[i]]*estM[i]+pow(estLinf[i],bLinf[group[i]])
...
# Bundle data
win.data <- list("r","M","Linf","n","group")

# Function to generate starting values
inits <- function()
  list (
    mu.bM=1,tau.bM=1,
    mu.bLinf=-2,tau.bLinf=1,
    bM=c(1,1,1),  bLinf=c(1,1,1),
    tau.M=1, tau.Linf=1, tau.r=1,
    estM=dat$M, estLinf=dat$Linf, 
    r.new=dat$r)
...
require(devEMF)
emf("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\residual plot mix without beta0.emf",
...
library(xlsx)
write.xlsx(stat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.xlsx",sheetName = "stat",row.names=T)
write.xlsx(coe,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.xlsx",sheetName = "coe",row.names=T,append=T)
write.xlsx(result,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.xlsx",sheetName = "result",row.names=T,append=T)
write.xlsx(waic_mat,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.xlsx",sheetName = "waic_mat",row.names=T,append=T)


#！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
# require(devEMF)
emf("E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.emf",
    width = 3.35, height = 3.35)
observed=r
BHEIV_predicted=out$mean$predicted#BHEIV model predicted r
plot(observed,col="red",pch=1, main = "rMLinfgroup mix without beta0",cex.main=0.8,
     xlab = "index",ylab="r")
...
write.xlsx(r_com,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.xlsx",sheetName = "r_com",row.names=T,append=T)
...
write.xlsx(p_com,"E:\\01-doctor_LCJ\\09-fishery\\02-r_LHPs paper\\20200312BHEIV\\rMLinfgroup\\mix without beta0.xlsx",sheetName = "p_com",row.names=T,append=T)
